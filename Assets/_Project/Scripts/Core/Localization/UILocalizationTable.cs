...
public class UILocalizationTable : ScriptableObject
{
    ...
    public static readonly string[] StandardUIKeys =
    {
        ...
        "ui_hint_adjust_qty",
        "shop_gain_label",
        "shop_confirm_sell_button",
        "shop_sell_cart_empty",
        "shop_back_to_sell",
        "shop_sell_confirm_message",
        "shop_sell_confirm_cancel",
        "shop_add_button",
        "ui_settings_sell_confirm",
        "ui_settings_sell_confirm_lv5",
        "ui_settings_sell_confirm_lv8",
        "ui_settings_sell_confirm_off",
