...
namespace sc.stylizedgrass.runtime
{
    ...
    public class GrassColorMapRenderer : MonoBehaviour
    {
        ...
        public void AssignVegetationStudioMeshTerrains()
        {
            ...
            AwesomeTechnologies.MeshTerrains.MeshTerrain[] terrains = FindObjectsByType<AwesomeTechnologies.MeshTerrains.MeshTerrain>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
